...
public class UserController {
    ...
    public ResponseEntity<GetUserDto.DetailResponse> getUser(@Auth AuthUser authUser) {
        ...
        return ResponseEntity
                .ok(new GetUserDto.DetailResponse(user));
    }
     ...
     */
    @GetMapping("/users/{id}")
    public ResponseEntity<GetUserDto.SimpleResponse> getUser(@Auth AuthUser authUser, @PathVariable Long id) {
        ...
        return ResponseEntity
                .ok(new GetUserDto.SimpleResponse(user));
    }
     ...
     */
    @PatchMapping("/users")
    public ResponseEntity<Void> update(@Auth AuthUser authUser, @RequestBody @Valid UserUpdateDto.Request request) {
        userService.update(authUser.getId(), request.getEmail(), request.getName(), request.getPassword(), request.getNewPassword());
     ...
     */
    @DeleteMapping("/users")
    public ResponseEntity<Void> delete(@Auth AuthUser authUser, @RequestBody UserDeleteDto.Request request) {
